...
class SubmissionsController < ApiController
  def create
    ...
    if submission_count.positive?
      ...
      passed = 0
      marks = 0
      if (submission = Submission.create(problem_id: problem_id, candidate_id: params[:candidate_id],
      ...
      test_cases = TestCase.where(problem_id: problem_id)
      ...
      render_success(data: { passed_testcases: passed, total_testcases: total, marks: marks,
